    ...
    <section className="bg-[#AEFBD2]">
      <div>
        ...
        <div className="flex items-start px-2">
          ...
          {/* right section */}
          <div className="flex flex-col w-2/5 h-full p-2 mx-2">
            <Card className="bg-[#25C1D6] m-2 text-white rounded-2xl w-full">
              <CardHeader>
                <CardTitle className="font-bold mb-5 text-white uppercase text-6xl">
                  Trends in global <br className="hidden lg:block" /> carbon
                  goals
                </CardTitle>
                <CardContent className="px-0 pb-12 text-xl text-white ">
                  <p className="py-2">
            ...
            <Card className="bg-[#25C1D6] m-2 text-white rounded-2xl w-full">
              <CardHeader>
                <CardTitle className="font-bold text-white uppercase mb-5 text-5xl">
                  global emissions <br className="hidden lg:block" /> target and
                  climate goals
                </CardTitle>
                <CardContent className="text-xl px-0 pb-4 text-white">
                  <p className="py-2">
